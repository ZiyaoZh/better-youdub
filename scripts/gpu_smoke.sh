...
docker compose -f "$COMPOSE_FILE" run "${RUN_FLAGS[@]}" \
  ...
  -e YOUDUB_TTS_INFERENCE_TIMESTEPS="${YOUDUB_TTS_INFERENCE_TIMESTEPS:-20}" \
  -e YOUDUB_TTS_MIN_REFERENCE_MS="${YOUDUB_TTS_MIN_REFERENCE_MS:-1500}" \
  -e YOUDUB_TTS_START_PAD_MS="${YOUDUB_TTS_START_PAD_MS:-150}" \
  -e YOUDUB_TTS_END_PAD_MS="${YOUDUB_TTS_END_PAD_MS:-300}" \
